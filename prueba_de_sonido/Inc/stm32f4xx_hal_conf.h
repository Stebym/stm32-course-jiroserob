 ...
 * @brief   Configuracion del HAL para prueba de sonido (buzzer en PA6).
 *          Solo se habilitan los modulos que realmente usa el proyecto:
 *          GPIO, RCC, CORTEX, FLASH, PWR, TIM. TIM3 genera el PWM en PA6
 *          (CH1) para poder probar tanto senal DC (buzzer activo) como tono
 *          variable (buzzer pasivo) — no se sabe con certeza cual de los dos
 *          esta conectado, por eso esta prueba cubre ambos casos.
 ******************************************************************************
 */
...
#define HAL_GPIO_MODULE_ENABLED     /* salida del buzzer + boton b1           */
#define HAL_PWR_MODULE_ENABLED      /* requerido por hal_init                 */
#define HAL_RCC_MODULE_ENABLED      /* relojes del sistema                    */
#define HAL_TIM_MODULE_ENABLED      /* tim3 ch1 (pa6): pwm hacia el buzzer     */
#define HAL_DMA_MODULE_ENABLED      /* stm32f4xx_hal_tim.h referencia DMA_HandleTypeDef aunque no se use */
